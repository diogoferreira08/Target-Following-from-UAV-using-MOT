...
class PublishData {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PublishData
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PublishData
    let len;
    let data = new PublishData(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new PublishData(null);
    if (msg.id !== undefined) {
      resolved.id = msg.id;
    }
    else {
